...
words = ['Plum', 'Grapefruit', 'apple', 'orange', 
         'pomegranate', 'Cranberry', 'lime', 'Lemon', 
         'grapes', 'persimmon', 'tangerine', 'Watermelon', 
         'currant', 'Almond', ]
first_symbol = set(symb[0].lower() for symb in words)
print(*sorted(first_symbol))
